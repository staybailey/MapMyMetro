...
CREATE TABLE trips (
  route_id INT(11), service_id INT(11), trip_id INT(11) NOT NULL, trip_headsign VARCHAR(255), trip_short_name VARCHAR(255), direction_id INT(11), block_id INT(11), shape_id INT(11), PRIMARY KEY (trip_id), FOREIGN KEY (route_id) REFERENCES routes(route_id)/* FOREIGN KEY (service_id), FOREIGN KEY (block_id), FOREIGN KEY (shape_id) */
);
